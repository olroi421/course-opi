...
## ▶️:fontawesome-solid-user-plus: Хід роботи
...
5. Підготовка, здача та захист лабораторної:
    ...
    3. підготувати звіт за запропонованим шаблоном ((:fontawesome-brands-markdown: завантажити звіт)[assets/report.md]{:download});
    4. як відповідь на завдання в LMS Moodle завантажити звіт звіт `report.md`;
