...
5. Підготовка, здача та захист лабораторної:
    ...
    3. підготувати звіт за запропонованим шаблоном (<a href="assets/report.txt" download="report.txt" type="text/plain">:fontawesome-solid-download: завантажити шаблон</a>);
