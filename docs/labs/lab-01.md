...
5. Підготовка, здача та захист лабораторної:
    ...
    3. підготувати звіт за запропонованим шаблоном (<a href="assets/report.txt" download="report.md" type="text/markdown">:fontawesome-solid-download: завантажити шаблон</a>);
