...
5. Протестувати роботу endpoints через Postman та сформувати звіт.
6. Виконати за бажанням завдання додаткового та творчого рівня.
6. Підготовка звіту лабораторної роботи:
    1. створити директорію `lab-reports/` і додати `lab05-report-student-id.md` для кожного учасника команди відповідно до шаблону звіту ([:fontawesome-solid-download: завантажити шаблон](assets/lab04-report-template.download){: download="lab04-report.md" });
